...
<div id="form-page" class="relative flex flex-col justify-between bg-black text-white min-h-screen">
    ...
    <div class="relative w-full max-w-xl md:max-w-2xl lg:max-w-3xl px-10 md:px-6 mx-auto mb-8 text-sm text-center md:text-sm ">
