...
<div id="form-page" class="relative flex flex-col justify-between bg-black text-white md2:h-[100vh]">
    ...
    <div class="relative w-full max-w-3xl px-10 md:px-6 mx-auto md2:mb-8 text-sm text-center md:text-sm ">
